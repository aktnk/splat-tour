...
- 視点が止まって約1秒たつと描画を止めます。移動・見回し・読み込み中だけ描画します。
  ...
  "scenes": [
    {
      ...
      "transform": { "flipX": false, "flipY": false, "flipZ": false, "scale": 1 },  // 省略可
...
- `transform` の `flipX` などは、その軸まわりに180度回転します。3DGSが上下逆さまのときは、まず `flipX: true` を試してください。
